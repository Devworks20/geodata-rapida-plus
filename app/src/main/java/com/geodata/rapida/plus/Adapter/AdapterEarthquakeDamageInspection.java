...
public class AdapterEarthquakeDamageInspection extends FragmentStatePagerAdapter
{
    private static final String TAG = AdapterEarthquakeDamageInspection.class.getSimpleName();

    CharSequence[] TitleOfTab;
    int NoOfTabs;
    String Status, Status2, ReasonForScreening;

    public AdapterEarthquakeDamageInspection(FragmentManager fm, CharSequence[] TitleOfTab, int NoOfTabs, String Status, String Status2, String ReasonForScreening)
    {
        super(fm);
