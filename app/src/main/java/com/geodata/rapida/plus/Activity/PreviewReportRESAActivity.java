...
public class PreviewReportRESAActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_preview_report_resa);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if (haveNetworkConnection(getApplicationContext()))
                {
                    ...
                    {
                        Toast.makeText(PreviewReportRESAActivity.this, "You already sent the PDF report.", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(PreviewReportRESAActivity.this, "You have no internet connection. try again later.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void initButtonSendPDF()
    {
        try
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(PreviewReportRESAActivity.this);
            builder.setTitle("Submit Report");
            builder.setMessage("Are you sure you want to submit this RESA Report?");
                ...
                public void onClick(DialogInterface dialog, int which)
                {
                    ...
                    if (file.exists())
                    {
                        ...
                        try
                        {
                            ...
                            Call<String> postRESAorDESAReport = apiInterface.PostRESAorDESAReport(PDFReport, sMissionOrderID);

                            postRESAorDESAReport.enqueue(new Callback<String>()
                            {
                                @Override
                                public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response)
                                {
                                    if (response.isSuccessful())
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            Toast.makeText(PreviewReportRESAActivity.this, "Failed to send PDF.", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                    else
                                    {
    ...
    private void initUpdateMissionOrderStatus()
    {
        try
        {
            ...
            Intent intent = new Intent(PreviewReportRESAActivity.this, NavigationActivity.class);
            startActivity(intent);
            finish();

            Toast.makeText(PreviewReportRESAActivity.this, "Successfully Submitted!", Toast.LENGTH_LONG).show();
        }
        catch (Exception e)
        {
            Log.e(TAG, e.toString());
